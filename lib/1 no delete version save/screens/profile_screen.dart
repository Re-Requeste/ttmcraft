...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Берём данные из patient (с безопасной проверкой)
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildCard('Full Name', name, Icons.person),
          _buildCard('Email', email, Icons.email),
          _buildCard('Treatment', treatment, Icons.medical_services),
          _buildCard('Status', status, Icons.info),
          _buildCard('Progress', progress, Icons.percent),
          const SizedBox(height: 24),
          ElevatedButton(
            onPressed: onLogout,
